...
## 4. Keep the Free Plan project active

The repository includes an optional, minimal GitHub Actions keep-alive for
Supabase project `vzqlcdhpywixbmjldhzf`.

Follow [SUPABASE_KEEPALIVE.md](./SUPABASE_KEEPALIVE.md) to apply the restricted
SQL function, confirm the existing GitHub secrets, and run the first manual
health check.
